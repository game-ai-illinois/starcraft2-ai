...
def select_rect(action, action_space, select_add, screen, screen2):
  ...
  # print("point right pixel: ", str(screen_rect.right) )
  # print("point left pixel: ", str(screen_rect.left) )
  # print("point top pixel: ", str(screen_rect.top) )
  # print("point bottom pixel: ", str(screen_rect.bottom) )
  # print("point height pixel: ", str(screen_rect.height) )
  # print("point width pixel: ", str(screen_rect.width) )
